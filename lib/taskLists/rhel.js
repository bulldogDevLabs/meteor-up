...
var SCRIPT_DIR = path.resolve(__dirname, '../../scripts/rhel');
var TEMPLATES_DIR = path.resolve(__dirname, '../../templates/linux');

exports.setup = function(config) {
  var taskList = nodemiral.taskList('Setup (rhel)');
...
exports.deploy = function(bundlePath, env, config) {
  ...
  var taskList = nodemiral.taskList("Deploy app '" + appName + "' (rhel)");
...
exports.reconfig = function(env, config) {
  ...
  var taskList = nodemiral.taskList("Updating configurations (rhel)");
...
exports.restart = function(config) {
  var taskList = nodemiral.taskList("Restarting Application (rhel)");
...
exports.stop = function(config) {
  var taskList = nodemiral.taskList("Stopping Application (rhel)");
...
exports.start = function(config) {
  var taskList = nodemiral.taskList("Starting Application (rhel)");
